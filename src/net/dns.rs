...
#[allow(unused)]
pub fn google_dns_host_socket_addr() -> SocketAddr {
...
impl DnsResolver {
    ...
    #[allow(unused)]
    pub fn new(host: SocketAddr) -> Result<Self, ()> {
    ...
    pub fn resolve(&mut self, host: &str, dns_server: SocketAddr) -> Result<in_addr, ()> {
